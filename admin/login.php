    ...
    <div class="card-body login-card-body">
      ...
      <form id="FormLogin">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Username" id="username" autocomplete required>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" id="password" autocomplete required>
          <div class="input-group-append">
            <div class="input-group-text">
