...
function RecommendationDetails() {
  $.post(
    "view/disease_recommendations/components/recommendations-details.php",
    {},
    function (data) {
...
function RecommendationsEntry(operation, id) {
  $.post(
    "view/disease_recommendations/components/recommendations-entry.php",
    {
      id: id,
      operation: operation,
    },
...
function DeleteRecommendations(id) {
  $.post(
    "view/disease_recommendations/actions/delete.php",
    {
      id: id,
    },
    function (data) {
...
function SaveRecommendations() {
  ...
  $.post(
    "view/disease_recommendations/actions/save.php",
    {
      disease: disease,
...
function UpdateRecommendations(id) {
  ...
  $.post(
    "view/disease_recommendations/actions/update.php",
    {
      id: id,
      disease: disease,
      recommendations: recommendations,
