...
<div class="col-12 col-xl-4 " id="">
    ...
    <ul id="recommendations">
        <?php
            $recommendations = $conn->prepare("SELECT * FROM recommendations WHERE type_id = ? AND type = 'Pest' ");
...
<div class="col-12 col-xl-4 " id="">
    ...
    <ul id="treatment">
        <?php
            $treatment = $conn->prepare("SELECT * FROM treatment WHERE type_id = ?  AND type = 'Pest' ");
